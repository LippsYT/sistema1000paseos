...
import type { Agency, Settlement, Provider, SettlementBooking, User, PaymentAccount } from "@/lib/types";
...
export default function PaymentsPage() {
  ...
  return (
    ...
    <Dialog open={!!viewingSettlement} onOpenChange={setViewingSettlement}>
          ...
          <Table>
            ...
            <TableBody>
              {filteredSettlements.length === 0 ? (
                <TableRow>
                    <TableCell colSpan={isArchiving ? 7 : 6} className="h-24 text-center">
